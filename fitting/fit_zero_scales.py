...
# Force the scale factors to be zero.
scales = replica.base_scale_parameters + ['gradient_rna_scale_ms_active_pepc',
                                          'gradient_rna_scale_ms_active_rubisco',
                                          'gradient_rna_scale_bs_active_rubisco']
zero_scales = dict.fromkeys(scales, 0.)
replica.fitting_model.set_bounds(zero_scales)
# Set options.
...
# Skip the postprocessing step: it was not found to help in this case.
# Collect and save the following information anyway:
...
filename = 'fit_zero_scales.pickle'
